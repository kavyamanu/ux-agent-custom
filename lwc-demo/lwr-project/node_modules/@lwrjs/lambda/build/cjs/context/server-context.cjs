...
var import_mrt_utils = __toModule(require("../mrt-utils.cjs"));
...
function createServerContext(build) {
  ...
  const mrtSsgRoot = (0, import_mrt_utils.getMrtSsgRoot)(build.appConfig.staticSiteGenerator);
  const runtimeEnvironment = builtRuntimeEnv.featureFlags.ASSETS_ON_LAMBDA ? builtRuntimeEnv : {
    ...builtRuntimeEnv,
    defaultAssetPath: (0, import_mrt_utils.getMrtArtifactUrl)(builtRuntimeEnv.basePath || "", mrtSsgRoot)
  };
