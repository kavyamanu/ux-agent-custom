...
// packages/@lwrjs/lambda/src/transformers/mrt-static-uri-transformer.ts
...
function mrtStaticUriTransformer() {
  return {
    ...
    async transformUri(uriDef, _def, runtimeEnvironment) {
      ...
      const uri = (0, import_mrt_utils.getMrtArtifactUrl)(runtimeEnvironment?.basePath || "", basePathlessUri);
      import_diagnostics.logger.debug({
        label: `${this.name}`,
