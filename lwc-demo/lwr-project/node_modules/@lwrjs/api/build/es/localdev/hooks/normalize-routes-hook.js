 ...
 * be able to resolve the loader shim or @lwc/engine-server from the static bundle provider.
...
export default class NormalizeRoutesStartHook {
    onStart(config) {
        const versionsPath = path.join(process.cwd(), 'app', 'localdev', 'versions.json');
