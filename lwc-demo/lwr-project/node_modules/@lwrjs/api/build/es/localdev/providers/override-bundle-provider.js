...
import { getLocalDevOverrideUrl } from '@lwrjs/shared-utils';
...
export default class StaticOverrideBundleProvider extends StaticBundler {
    ...
    async bundle(moduleId, runtimeEnvironment, runtimeParams) {
        ...
        if (this.writeProdBundlesDir) {
            const prodPath = path.join(this.writeProdBundlesDir, 'site', 'prod', 'view', 'en-US', dirname, fileName);
        ...
        const cachePath = getLocalDevOverrideUrl(this.cacheDir, moduleId.specifier, fullPath);
