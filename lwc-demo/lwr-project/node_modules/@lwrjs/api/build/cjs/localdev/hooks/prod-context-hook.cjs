...
// packages/@lwrjs/api/src/localdev/hooks/prod-context-hook.ts
__markAsModule(exports);
__export(exports, {
  default: () => prod_context_hook_default
});
var import_path = __toModule(require("path"));
var import_normalize_routes_hook = __toModule(require("./normalize-routes-hook.cjs"));
var ProdStartHook = class {
...
var prod_context_hook_default = ProdStartHook;
