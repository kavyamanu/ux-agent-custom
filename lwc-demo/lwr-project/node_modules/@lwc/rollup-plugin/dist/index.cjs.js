...
function lwc(pluginOptions = {}) {
    ...
    const { targetSSR, stylesheetConfig, sourcemap = false, preserveHtmlComments, experimentalDynamicComponent, experimentalDynamicDirective, enableDynamicComponents, enableLightningWebSecurityTransforms, 
    ...
    return {
        ...
        transform(src, id) {
            ...
            const [namespace, name] = specifier?.split('/') ?? path.dirname(filename).split(path.sep).slice(-2);
