...
function isGaterEnabledFeature$LWS(featureName$LWS) {
  return ReflectApply$LWS(ArrayProtoIncludes$LWS, gaterEnabledFeatures$LWS, [`com.salesforce.locker.${featureName$LWS}`]);
}
