...
import { sanitizeURLForElement as sanitizeURLForElement$LWS, isValidURLScheme as isValidURLScheme$LWS, parseURL as parseURL$LWS, isValidURL as isValidURL$LWS, resolveURL as resolveURL$LWS, isMIMETypeAllowed as isMIMETypeAllowed$LWS } from '@locker/shared-url';
          ...
          if (unsanitizedValue$LWS !== null && unsanitizedValue$LWS !== undefined) {
            ...
            if (loweredCommand$LWS === 'inserthtml') {
              ...
              if (type$LWS === 0 /* SandboxType.External */) {
                ...
                if (isSharedElement$r$LWS(activeElement$LWS) && ReflectApply$LWS(originalIsContentEditable$LWS, activeElement$LWS, [])) {
    ...
    if (isSharedElement$q$LWS(this)) {
      for (let i$LWS = 0, {
        ...
        if (!isAllowedSharedElementChild$6$LWS(argValue$LWS)) {
          const nodeNameOrString$LWS = argValue$LWS instanceof Node$LWS ? ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, argValue$LWS, []) : /* istanbul ignore next: currently unreachable via tests */toString$LWS(argValue$LWS);
...
function initDistortionHTMLLinkElementRelListSetter$LWS({
  ...
  const distortionEntry$LWS = [originalRelListSetter$LWS, function relList$LWS(relListValue$LWS) {
    const string$LWS = relList$LWS instanceof DOMTokenList$LWS ? /* istanbul ignore next: needs default platform behavior test */ReflectApply$LWS(DOMTokenListProtoValueGetter$LWS, relListValue$LWS, []) : toString$LWS(relListValue$LWS);
  ...
  return function distortionURLCreateObjectURL$LWS({
    ...
    return [originalCreateObjectURL$LWS, function createObjectURL$LWS(blobObject$LWS) {
      ...
      if (HTML_MIME_TYPES_LIST$LWS.includes(loweredBlobType$LWS)) {
        ...
        if (!isEqualDomString$LWS(trusted$LWS.createHTML(responseText$LWS), trusted$LWS.createHTML(sanitized$LWS))) {
          URLRevokeObjectURL$LWS(outURL$LWS);
          throw new LockerSecurityError$LWS(createInsecureBlobErrorMessage$LWS(blobObject$LWS));
        }
        return outURL$LWS;
