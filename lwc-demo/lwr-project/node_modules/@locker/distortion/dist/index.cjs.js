          ...
          if (unsanitizedValue$LWS !== null && unsanitizedValue$LWS !== undefined) {
            ...
            if (loweredCommand$LWS === 'inserthtml') {
              ...
              if (type$LWS === 0 /* SandboxType.External */) {
                ...
                if (isSharedElement$r$LWS(activeElement$LWS) && shared$LWS.ReflectApply(originalIsContentEditable$LWS, activeElement$LWS, [])) {
    ...
    return [originalInsertAdjacentHTML$LWS, function insertAdjacentHTML$LWS(...args$LWS) {
      ...
      if (args$LWS.length > 1) {
        ...
        if (isInherentlyUnsecure$2$LWS(args$LWS[1])) {
          throw new shared$LWS.LockerSecurityError(`Cannot 'insertAdjacentHTML' using an unsecure ${shared$LWS.toSafeTemplateStringValue(args$LWS[1])}.`);
        }
      }
  ...
  return function distortionElementOuterHTMLSetter$LWS({
    ...
    return [originalOuterHTMLSetter$LWS, function outerHTML$LWS(value$LWS) {
      ...
      if (isInherentlyUnsecure$1$LWS(html$LWS)) {
        throw new shared$LWS.LockerSecurityError(`Cannot set 'outerHTML' using an unsecure ${shared$LWS.toSafeTemplateStringValue(html$LWS)}.`);
      }
...
function initDistortionEval$LWS({
  ...
  return function distortionEval$LWS({
    ...
    return [originalEval$LWS, function (sourceText$LWS) {
      ...
      return sandboxEvaluator$LWS(sharedDom$LWS.transformSourceText(shared$LWS.toString(sourceText$LWS)), UNCOMPILED_CONTEXT$LWS);
    }];
  };
}
