...
function createEvalHelpersFactoryArgs$LWS(record$LWS) {
  ...
  function loadScript$LWS(_thisArg$LWS, url$LWS) {
    const urlResolved$LWS = sharedUrl$LWS.resolveURL(shared$LWS.toString(url$LWS));
...
function toSourceText$LWS(value$LWS, sourceType$LWS) {
  let sourceText$LWS = typeof value$LWS === 'function' ? shared$LWS.extractFunctionBodySource(value$LWS) : shared$LWS.toString(value$LWS);
...
function createVirtualEnvironment$LWS(record$LWS) {
  ...
  } else if (shared$LWS.ReflectApply(shared$LWS.StringProtoStartsWith, key$LWS, ['devopsimpkg'])) {
    remapTypedArrays$LWS = false;
  }
  return createIframeVirtualEnvironment$LWS(globalObject$LWS, {
    ...
    !remapTypedArrays$LWS && shared$LWS.isLockerFeatureEnabled('isLockerNextForOmnistudioEnabled') || IFRAME_KEEP_ALIVE_FLAG$LWS,
